...
const QuestionPanel = ({ problemID, question, setpage, page }) => {
  ...
  return (
    <div className="flex flex-col gap-3 px-2 py-2 rounded-lg">
      ...
      <div>
        <button
          className="border-[0.1px] border-yellow-500 rounded-xl p-2 flex gap-2 items-center justify-center"
          onClick={() => getHints()}
        >
          <img
            src="/assets/icon/light_bulb.png"
            alt="light_buble"
            height={18}
            width={18}
          />
          <h1 className="text-lg text-center text-slate-300 font-thin">
            Take Hint
          </h1>
        </button>
      </div>
          ...
          <div className="flex flex-col p-2 space-y-2 shadow-2xl bg-slate-600 rounded-xl">
            ...
            <div className="mt-4 pt-4 border-t border-gray-400">
              <div className="flex flex-row justify-between">
                ...
                <div className="text-gray-400 font-bold">Powered By </div>
